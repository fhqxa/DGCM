# config/cub200_config_5way_5shot.py
...
dsp_config['dsp_iterations'] = 1
dsp_config['k_neighbors'] = 5
dsp_config['alpha_init'] = 0.1
dsp_config['beta_init'] = 0.8
# 温度参数（分别控制Instance图、Prototype图、Guidance）
dsp_config['tau_instance'] = 0.1
dsp_config['tau_proto'] = 0.1
dsp_config['tau_guidance'] = 0.1
